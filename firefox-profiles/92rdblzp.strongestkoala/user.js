...
user_pref("extensions.allowPrivateBrowsingByDefault", true); // If set to true, it allows extensions to be used in private mode by default
user_pref("browser.ctrlTab.recentlyUsedOrder", false); // If set to true, ctrl+tab will cycle tabs in the most recently used order
user_pref("media.videocontrols.picture-in-picture.enabled", false); // Enable or disable picture-in-picture mode
user_pref("browser.warnOnQuit", false); // Warns you when closing the browser if multiple tabs are open
user_pref("browser.safebrowsing.malware.enabled", false); // Blocks dangerous and deceptive content; uses Google services
